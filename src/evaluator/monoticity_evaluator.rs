...
pub struct MonoticityEvaluator {}

impl Evaluator for MonoticityEvaluator {
...
mod tests {
    ...
    #[test]
    fn test_monoticity_evaluator_1() {
        let board = Board {
    ...
    #[test]
    fn test_monoticity_evaluator_2() {
        let board = Board {
    ...
    #[test]
    fn test_monoticity_evaluator_3() {
        let board = Board {
